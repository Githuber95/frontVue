      ...
      b-container
        div.box-cotiza
          b-row.cotiza.pt-5.vale_descuento.px-lg-0(ref="cotiza")
                  ...
                  b-row.align-items-center.h-100
                    b-col(cols="6")
                      div
                        ...
                        img.text-left.mt-3(src="@/static/media/ahorro_seguro/home/mensaje-responsive.svg" alt="mensaje ahorro seguro de vida" style="width: 19rem;")
            ...
            b-col.title.left.mt-lg-0.d-lg-none(cols="12" lg="6" xl="7" order="1" order-lg="2")
              b-row.principal.justify-content-center.justify-content-lg-left
                b-col.px-0.px-lg-0.mt-2(cols="12")
                  img.pl-4(src="@/static/media/ahorro_seguro/home/mensaje-responsive.svg" alt="mensaje ahorro seguro de vida")
        ...
        div.elegir.como-funciona_seguro-vida.py-1.pt-xl-3.pb-xl-0(ref="concepto")
          b-container
            ...
            b-row.d-none.d-lg-flex(align-h="end")
              b-col.pl-5.mt-4.mb-3.my-md-4(lg="9" align-self="end")
                //- h2.text-primary.omnes-medium Jorge<span class="omnes-semibold"> ahorra y protege <br class="d-lg-none">intereses</span> para su <br class="d-none d-lg-block"> futuro, conoce c&oacute;mo:
            ...
            b-row.justify-content-center.d-lg-none
              b-col.mt-3(cols="12" sm="9" md="7")
                img.w-100(src="@/static/media/ahorro_seguro/home/elegir-ahorro_seguro_mobile.svg" alt="por que elegir ahorro seguro")
              b-col.mt-3(cols="12" sm="9" md="7")
                b-row
                  b-col.px-1(cols="2")
                    img.w-100(src="@/static/media/ahorro_seguro/home/protege.svg" alt="protege ahorro seguro")
                  b-col(cols="10")
                    h4.lh-1 Te ofrecemos una cobertura por fallecimiento para que quienes más amas estén protegidos.
                  b-col.text-right(cols="12")
                    img(src="@/static/media/ahorro_seguro/home/chanchito-ahorrador.svg" alt="protege ahorro seguro" style="margin-top: -1rem;")
            b-row.justify-content-center.d-none.d-lg-flex
              b-col.mt-3(cols="12")
                b-row
                  b-col.px-1(cols="3")
                    img.w-100(src="@/static/media/ahorro_seguro/home/hombre_ahorro_seguro_desktop.svg" alt="porq que elegir ahorro seguro")
                  b-col.pl-5.mt-5(cols="9")
                    ...
                    b-row.align-items-center.mt-5
                      b-col.px-0.text-center(cols="1")
                        img.w-50(src="@/static/media/ahorro_seguro/home/protege.svg" alt="protege ahorro seguro")
                      b-col.pl-0(cols="10")
            ...
            b-col.title.text-center(cols="12")
              b-row(align-h="center")
                b-col.px-lg-2(cols="12" sm="7" md="6" lg="4" xl="6")
                  img.mb-2.d-lg-none(src="@/static/media/ahorro_seguro/home/check_green.svg" alt="beneficios" style="width: 2rem")
                  h2.omnes-medium.text-primary.d-xl-inline Mira todo lo que <br class="d-lg-none">te ofrecemos
                  img.mb-2.d-none.d-xl-inline.ml-xl-3(src="@/static/media/ahorro_seguro/home/check_green.svg" alt="beneficios" style="width: 2rem")
            b-col.content(cols="12" lg="9")
              b-row.text-center.px-xl-0
                b-col.my-3.px-xl-1(cols="12" lg="4")
                  b-row.px-xl-0(align-h="center")
                    b-col.img-beneficio(cols="12")
                      img.mb-2(src="@/static/media/ahorro_seguro/home/beneficio_sin_cobros_extras.svg" alt="beneficio sin cobros extras")
                ...
                b-col.my-3.px-xl-1(cols="12" lg="4" order-xl="2")
                  b-row.px-xl-0(align-h="center")
                    b-col.img-beneficio(cols="12")
                      img.mb-2(src="@/static/media/ahorro_seguro/home/beneficio_cobro_automatico.svg" alt="beneficio devolucion de seguro de vida")
                ...
                b-col.mt-3.px-xl-1(cols="12" lg="4" order-xl="3")
                  b-row(align-h="center")
                    b-col.img-beneficio(cols="12")
                      img.mb-2.mb-xl-2(src="@/static/media/ahorro_seguro/home/beneficio_asistencias.svg" alt="beneficio en los contratos de tu seguro de vida")
...
export default {
  ...
  created () {
    this.$store.commit('common/setSubchannel', 'V2_SEGURO')
