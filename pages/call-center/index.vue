   ...
   div
    section#home(ref="home")
      b-container
        div.box-cotiza
          b-row.cotiza.pt-5.vale_descuento(ref="cotiza")
            b-col.title.left.mt-lg-0.vale_descuento(cols="12" lg="6" xl="7" order="1" order-lg="2" lazy-background="~/static/media/common/home/banner_descuento-responsive.svg")
              ...
              a.d-xl-none.text-primary(href='/seguro-de-vida/tyc') *T&eacute;rminos y condiciones  
                span.omnes-semibold aqu&iacute;
              a.d-none.d-xl-block.text-primary(href='/seguro-de-vida/tyc') *Ver T&eacute;rminos y condiciones
          ...
          b-container
            ...
            b-row.justify-content-center.d-lg-none
              b-col.mt-3.mb-5(cols="11" sm="9" md="7")
                img.w-100(src="@/static/media/seguro_vida/home/linea_tiempo_mobile.png" alt="linea de tiempo")
            b-row.justify-content-center.d-none.d-lg-flex
              b-col.mt-3.mb-5(cols="12")
                img.w-100(src="@/static/media/seguro_vida/home/linea_tiempo.png" alt="linea de tiempo")
        ...
        b-row.asistencia(style="background-color: rgba(241,244,249,0.50196)")
          b-container
            b-row.pb-4.pb-xl-5
              b-col.text-center(cols="12")
...
export default {
  ...
  created () {
    this.$store.commit('common/setSubchannel', 'PROMOCION_CENTER')
