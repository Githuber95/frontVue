  ...
  div.proteccion#home(ref="home")
    section
      b-container
        div.box-cotiza
          b-row.cotiza.pt-5.vale_descuento(ref="cotiza")
            b-col.title.left.mt-lg-0.vale_descuento(cols="12" lg="6" xl="7" order="1" order-lg="2" lazy-background="~/static/media/common/home/banner_descuento-responsive.svg")
              h1(style="color:transparent; position: absolute;") Protecci&oacute;n Segura
              ...
              a.d-none.d-xl-block.text-primary(href='/seguro-de-vida/tyc' style="color: #fff !important;") *Ver T&eacute;rminos y condiciones
              ...
              //- b-row.principal.justify-content-center.justify-content-lg-left
                ...
                // counter(:codeTime="1616389199").w-100.pl-lg-5.box_principal-contador
                ...
                b-col.px-0.px-lg-0(cols="12")
                  h1.omnes-medium.text-primary.lh-1.d-xl-none Deja a los que m&aacute;s amas protegidos
                    p.omnes-semibold.pt-0 en caso un d&iacute;a no est&eacute;s</span>
                  h1.omnes-medium.text-primary.lh-1.d-none.d-xl-block Deja a los que m&aacute;s amas  <hr class="my-2"> protegidos <br> <span class="omnes-semibold">en caso</span> <hr class="my-2"> <span class="omnes-semibold">un d&iacute;a no est&eacute;s</span>
                    ...
                    b-col(cols="12")
                      b-row
                        b-col.text-center(cols="12")
                          h3.text-primary.omnes-medium Cotiza tu seguro de protección segura
          ...
          b-container
            b-row
              b-col.text-center.mt-4.mb-3.my-md-4
                h2.text-primary.omnes-medium Jorge <span class="omnes-semibold"> protege el futuro de <br class="d-lg-none">su  familia</span>  con un <br class="d-none d-lg-block">monto <br class="d-lg-none"> m&iacute;nimo, conoce cómo:
            b-row.justify-content-center.d-lg-none
              b-col.mt-3.mb-5(cols="11" sm="9" md="7")
                img.w-100(src="@/static/media/proteccion_segura/home/linea_tiempo-proteccion_segura_mobile.svg" alt="linea de tiempo proteccion segura")
            b-row.justify-content-center.d-none.d-lg-flex
              b-col.mt-3.mb-5(cols="12")
                img.w-100(src="@/static/media/proteccion_segura/home/linea_tiempo-proteccion_segura.svg" alt="linea de tiempo proteccion segura")
        ...
        b-row.beneficios_mercado.justify-content-center(ref="beneficios_mercado" v-if="showSections")
          b-col.title.text-center(cols="12")
            b-row(align-h="center")
              b-col.px-lg-2(cols="12" sm="7" md="6" lg="10" xl="10")
                h2.omnes-medium.text-primary Tenemos los mejores beneficios del mercado
          b-col.content(cols="12" lg="11" xl="10")
            b-row.text-center.px-xl-0
              b-col.my-3.px-xl-1(cols="12" lg="4")
                b-row.px-xl-0(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2(src="@/static/media/seguro_vida/home/beneficio_protege_seguro_vida.svg" alt="beneficio online de proteccion segura")
                  b-col.px-4.mt-2.mb-xl-2.px-xl-1(cols="12")
              ...
              b-col.my-3.px-xl-1(cols="12" lg="4")
                b-row(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2.mb-xl-2(src="@/static/media/seguro_vida/home/beneficio_online_seguro_vida.svg" alt="beneficio online de proteccion segura")
              ...
              b-col.my-3.px-xl-1(cols="12" lg="4")
                b-row(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2.mb-xl-2(src="@/static/media/seguro_vida/home/beneficio_contrato_largo_seguro_vida.svg" alt="beneficio en los contratos de tu seguro proteccion segura")
                  b-col.px-4.px-xl-0.mt-2.mb-xl-2(cols="12")
          ...
          b-col.content.text-center.px-4.px-lg-0(cols="12")
            b-row(align-h="center")
              b-col.o-hidden.px-lg-0(cols="12" lg="11" xl="12")
                b-row
                b-carousel.d-lg-none(:interval="10000" indicators='' label-indicators="Selecciona un slide para mostrar")
                  b-carousel-slide(img-blank  img-alt="comentarios seguro de proteccion segura")
                    img(src="@/static/media/seguro_vida/home/icono_protege.svg" alt="icono protege proteccion segura")
                    b-row.d-flex.d-xl-none
                      b-col.text-center(cols="12" lg="4")
                        img.icono-testimonio(src="@/static/media/proteccion_segura/home/testimonio_giovana-proteccion_total.png" alt="testimonio de proteccion segura")
                      b-col.text-center.px-0.mt-4(cols="12")
                        h4 “Siempre tuve miedo que algo me pase y <br>mi familia tenga preocupaciones <br>económicas. Pagando <span class="text-primary omnes-semibold">S/ 30</span> al mes mi <br>familia recibirá <span class="text-primary omnes-semibold">S/ 200,000</span>en caso algo <br>me suceda.”
                        h3.omnes-medium.mt-2(style="color: #454A6C;") Giovana Castro <span class="d-block omnes-medium lh-1"> 32 años</span>
                  b-carousel-slide(img-blank img-alt="comentarios seguro de proteccion segura")
                    img(src="@/static/media/seguro_vida/home/icono_protege.svg" alt="icono protege proteccion segura")
                    b-row.d-flex.d-xl-none
                      b-col.text-center(cols="12" lg="4")
                        img.icono-testimonio(src="@/static/media/proteccion_segura/home/testimonio_stefano-proteccion_total.png" alt="testimonio de proteccion segura")
                      b-col.text-center.px-0.mt-4(cols="12")
                        h4 “Me siento tranquilo protegiendo a mi <br>familia con <span class="text-primary omnes-semibold">S/ 200,000 </span>si algo me pasa <br>pagando <span class="text-primary omnes-semibold">S/ 79</span> al mes. ¡Siempre es buen <br>momento para prevenir! “
                        h3.omnes-medium.mt-2(style="color: #454A6C;") Stefano Ramirez <span class="d-block omnes-medium lh-1"> 45 años</span>
                  b-carousel-slide(img-blank  img-alt="comentarios seguro de proteccion segura")
                    img(src="@/static/media/seguro_vida/home/icono_protege.svg" alt="icono protege proteccion segura")
                    b-row.d-flex.d-xl-none
                      b-col.text-center(cols="12" lg="4")
                        img.icono-testimonio(src="@/static/media/proteccion_segura/home/testimonio_bernardo-proteccion_total.png" alt="testimonio de proteccion segura")
                      b-col.text-center.px-0.mt-4(cols="12")
                        h4 “Nunca se sabe qué es lo que nos depara<br> el destino. Ahora me siento tranquilo <br>protegiendo a mis hijos con <span class="text-primary omnes-semibold">S/ 150,000</span><br> en caso algo me pase pagando tan solo <br> <span class="text-primary omnes-semibold">S/ 86</span> al mes.”
                        h3.omnes-medium.mt-2(style="color: #454A6C;") Bernardo Solis <span class="d-block omnes-medium lh-1"> 48 años</span>
                b-row.box.justify-content-center.px-0.d-none.d-lg-flex
                  b-col(lg="4" xl="3")
                    div.borde
                      ...
                      b-row.d-flex
                        b-col.text-center(cols="12")
                          img.icono-testimonio(style="width: 80px;" src="@/static/media/proteccion_segura/home/testimonio_giovana-proteccion_total.png" alt="testimonio de proteccion segura")
                  ...
                  b-col(lg="4" xl="3")
                    div.borde
                      ...
                      b-row.d-flex
                        b-col.text-center(cols="12")
                          img.icono-testimonio(style="width: 80px;" src="@/static/media/proteccion_segura/home/testimonio_stefano-proteccion_total.png" alt="testimonio de proteccion segura")
                        b-col.text-center.mt-4.mb-3.px-0(cols="12")
                          h4 “Me siento tranquilo protegiendo a mi <br>familia con <span class="text-primary omnes-semibold">S/ 200,000 </span>si algo me pasa <br>pagando <span class="text-primary omnes-semibold">S/ 79</span> al mes. ¡Siempre es buen <br>momento para prevenir! “
                          h3.omnes-medium.mt-2(style="color: #454A6C;") Stefano Ramirez <span class="d-block omnes-medium lh-1"> 45 años</span>
                  b-col(lg="4" xl="3")
                    div.borde
                      ...
                      b-row.d-flex
                        b-col.text-center(cols="12")
                          img.icono-testimonio(style="width: 80px;" src="@/static/media/proteccion_segura/home/testimonio_bernardo-proteccion_total.png" alt="testimonio de proteccion segura")
                        b-col.text-center.mt-4.mb-3.px-0(cols="12")
                          h4 “Nunca se sabe qué es lo que nos depara<br> el destino. Ahora me siento tranquilo <br>protegiendo a mis hijos con <span class="text-primary omnes-semibold">S/ 150,000</span><br> en caso algo me pase pagando tan solo <br> <span class="text-primary omnes-semibold">S/ 86</span> al mes.”
                          h3.omnes-medium.mt-2(style="color: #454A6C;") Bernardo Solis <span class="d-block omnes-medium lh-1"> 48 años</span>
...
export default {
  ...
  data () {
    return {
      ...
      preguntasFrecuentes: [
        {
          id: 'pregunta1',
          preguntas: '¿Qué es un seguro de protección segura?',
          // imagen: require("@/static/media/seguro_vida/home/asistencia_academica.svg"),
          styleCss: 'height: 7rem;',
          respuestas: [
              '<h3>Es un seguro que te ofrece protección para los que más amas en caso de fallecimiento natural o por accidente.</h3>'
          ]
        },
        {
          id: 'pregunta2',
          preguntas: '¿Para qué sirve un seguro de protección segura?',
          styleCss: 'height: 7rem;',
          respuestas: [
              '<h3>Este seguro te permite vivir tranquilo ya que puedes proteger ante algún imprevisto hasta 4 personas de tu familia.</h3>'
          ]
        },
        {
          id: 'pregunta3',
          preguntas: '¿Cuánto cuesta tu seguro de protección segura?',
          styleCss: 'height: 7rem;',
          respuestas: [
        ...
        {
          id: 'pregunta4',
          preguntas: '¿Por qué es importante tener un seguro de protección segura?',
          styleCss: 'height: 7rem;',
          respuestas: [
              '<h3> - Te permite proteger el estilo de vida de tu familia</h3>',
              '<h3> - Asegura el futuro de tus hijos.</h3>',
  ...
  head: {
    title: 'Deja a los que más amas protegidos - Protección segura',
    meta: [
      { hid: 'description', name: 'description', content: 'Protección segura, deja a los que más amas protegidos en caso un día no estés. Fácil, rápido y lo mejor de todo, 100% digital desde S/ 0.8 al día.' },
      { hid: 'keywords', name: 'keywords', content: 'seguros, protección segura, protección segura, seguro de protección segura, cubrimos coronavirus, coronavirus, protección segura nacional, protección segura internacional' },
      { hid: 'author', name: 'author', content: 'Interseguro | Protección segura' },
      { hid: 'copyright', name: 'copyright', content: 'Interseguro Protección segura' },
      // Facebook
      { hid: 'fb:og:title', property: 'og:title', content: 'Deja a los que más amas protegidos en caso un día no estés' },
      { hid: 'fb:og:image', property: 'og:image', content: process.env.base + 'seguro-de-vida/media/images/share/card_facebook_proteccion_total.png' },
      { hid: 'fb:og:url', property: 'og:url', content: process.env.base + 'seguro-de-vida/proteccion-segura' },
      { hid: 'fb:og:description', property: 'og:description', content: 'Fácil, rápido y lo mejor de todo, 100% digital desde S/ 0.8 al día.' },
      { hid: 'fb:og:site_name', property: 'og:site_name', content: 'Protección segura Interseguro' },
      { hid: 'fb:og:image:alt', property: 'og:image:alt', content: 'Interseguro, Protección segura' },
      // whatsapp
      { hid: 'wsp:image', property: 'og:image', itemprop: 'image', content: process.env.base + 'seguro-de-vida/media/images/share/card_whatsapp_proteccion_total.png' },
      // // Twitter
      { hid: 'twitter:title', property: 'twitter:title', content: 'Deja a los que más amas protegidos en caso un día no estés' },
      { hid: 'twitter:image', property: 'twitter:image', content: process.env.base + 'seguro-de-vida/media/images/share/card_facebook_proteccion_total.png' },
  ...
  created () {
    this.$store.commit('common/setSubchannel', 'PROMOCION_SEGURA')
