  ...
  div
    section#home(ref="home")
      b-container
            ...
            b-col.title.left.mt-lg-0.vale_descuento(cols="12" lg="6" xl="7" order="1" order-lg="2" lazy-background="~/static/media/common/home/banner_descuento-responsive.svg")
              ...
              // b-row.principal.justify-content-center.justify-content-lg-left
                // b-col.d-lg-none(cols="12" sm="9" md="8")
                  img.w-100.mt-sm-4(v-lazy-load data-src="@/static/media/seguro_vida/home/banner_hotsale-completo.png" alt="hot sale descuento")
                // b-col.d-none.d-lg-block.pl-xl-5(cols="12")
                  img.w-100.mt-1.mt-sm-3(v-lazy-load data-src="@/static/media/seguro_vida/home/banner_hotsale-desktop.png" alt="hot sale descuento")
                  ...
                  b-row.h-100
                    b-col(cols="12")
                      ...
                      //- b-row.justify-content-center.mt-2.mt-lg-3
                        b-col(cols="11" lg="10")
                          div.asegurados
                            img(data-src="media/seguro_vida/home/asegurados.svg" alt="asegurados" v-lazy-load)
                      ...
                      b-row.mt-2.mt-lg-3.mb-4.mb-lg-5
                        b-col.text-center
                          ...
                          img.d-inline.text-center.mt-lg-0.ml-2( v-lazy-load style="width: 6.5rem;" data-src="@/static/media/seguro_vida/home/grupo_intercorp.svg" alt="respaldo de intercorp" stlye="width:104px;height:22px;")        
        div.concepto.como-funciona_seguro-vida.py-1.py-xl-3.mt-5#concepto(ref="concepto")
          b-container
            b-row
              b-col.text-center.mt-4.mb-3.my-md-4
                h2.text-primary.omnes-medium Jorge <span class="omnes-semibold"> ahorra</span> y <span class="omnes-semibold">protege</span>  <br class="d-lg-none">a quienes <br class="d-none d-lg-inline">más ama,  <br class="d-lg-none">conoce cómo:
            b-row.justify-content-center.d-lg-none
              b-col.mt-3.mb-5(cols="11" sm="9" md="7")
                img.w-100.h-auto(v-lazy-load data-src="@/static/media/seguro_vida/home/linea_tiempo_mobile.png" alt="linea de tiempo")
            b-row.justify-content-center.d-none.d-lg-flex
              b-col.mt-3.mb-5(cols="12")
                img.w-100(v-lazy-load data-src="@/static/media/seguro_vida/home/linea_tiempo.png" alt="linea de tiempo")
              ...
              b-col.content(cols="12")
                b-row.mb-lg-4.align-items-center 
                  b-col.d-none.d-lg-block(cols="12" lg="6")
                    img.w-100.h-auto(v-lazy-load data-src="@/static/media/seguro_vida/home/paso_1_y_paso_2.svg" alt="paso 1 y paso 2")
                    ...
                    b-row
                      b-col.my-3.pr-0(cols="12" lg="12")
                        b-row.align-items-center.justify-content-center.justify-content-lg-end
                          b-col.text-right.pr-0.px-xl-0(cols="3")
                            img(v-lazy-load data-src="@/static/media/seguro_vida/home/paso_1.svg" alt="paso 1 mantenernos en contacto")
                      ...
                      b-col.my-3.pr-0(cols="12" lg="12")
                        b-row.align-items-centr.justify-content-center.justify-content-lg-end
                          b-col.text-right.pr-0.px-xl-0(cols="3")
                            img(v-lazy-load data-src="@/static/media/seguro_vida/home/paso_2.svg" alt="paso 2 cotiza un seguro a tu medida")
                          b-col.pr-0.pl-3(cols="8" xl="9")
                ...
                b-row.align-items-center 
                  b-col.px-1(cols="12" lg="6")
                    b-row
                      // b-col.my-3.pr-0(cols="12" lg="12")
                        b-row.align-items-center.justify-content-center.justify-content-lg-start
                          b-col.text-right.text-lg-left.pr-0.px-xl-0(cols="3")
                            img(v-lazy-load data-src="@/static/media/seguro_vida/home/paso_3.svg" alt="paso 3 elige a quienes proteger")
                      ...
                      b-col.my-3.pr-0(cols="12" lg="12")
                        b-row.align-items-center.justify-content-center.justify-content-lg-start
                          b-col.text-right.text-lg-left.pr-0.px-xl-0(cols="3")
                            img(v-lazy-load data-src="@/static/media/seguro_vida/home/paso_4.svg" alt="paso 4 paga y listo")
                          b-col.pr-0.pl-3.pl-lg-0(cols="8" xl="9")
                            p.text-secondary.omnes-medium Paso 3
                  ...
                  b-col.d-none.d-lg-block(cols="12" lg="6")
                    img.w-100.h-auto(v-lazy-load data-src="@/static/media/seguro_vida/home/paso_3_y_paso_4.svg" alt="paso 3 y paso 4")
          ...
          b-col.content(cols="12")
            b-row.text-center.px-xl-0
              b-col.my-3.px-xl-1(cols="12" lg="3")
                b-row.px-xl-0(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2(v-lazy-load data-src="@/static/media/seguro_vida/home/beneficio_protege_seguro_vida.svg" alt="beneficio online de seguro universitario")
              ...
              b-col.my-3.px-xl-1(cols="12" lg="3")
                b-row(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2.mb-xl-2(v-lazy-load data-src="@/static/media/seguro_vida/home/beneficio_online_seguro_vida.svg" alt="beneficio online de seguro universitario")
              ...
              b-col.my-3.px-xl-1(cols="12" lg="3")
                b-row.px-xl-0(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2(v-lazy-load data-src="@/static/media/seguro_vida/home/beneficio_devolucion_seguro_vida.svg" alt="beneficio devolucion de seguro universitario")
              ...
              b-col.my-3.px-xl-1(cols="12" lg="3")
                b-row(align-h="center")
                  b-col.img-beneficio(cols="12")
                    img.mb-2.mb-xl-2(v-lazy-load data-src="@/static/media/seguro_vida/home/beneficio_contrato_largo_seguro_vida.svg" alt="beneficio en los contratos de tu seguro universitario")
        ...
        b-row.asistencia(ref="asistencia" style="background-color: rgba(241,244,249,0.50196)" v-if="showSections")
          b-container
            b-row.pb-4.pb-xl-5
              b-col.text-center(cols="12")
          ...
          b-container.pb-5
            b-row(align-h="center")
              b-col.o-hidden.px-0(cols="10" sm="8" md="7" lg="5" xl="12")
          ...
          b-container
            b-row
              b-col.text-center(cols="12")
                h3.omnes-medium.text-primary(style="font-size: 1.4rem;") Para más detalle de las asistencias y beneficios visita <a target="_blank" href="https://www.interseguro.pe/vivemas" rel="noopener" class="omnes-semibold text-primary">VIVE +</a>
              ...
              b-col.o-hidden.px-lg-0(cols="12" lg="11" xl="12")
                ...
                b-carousel.d-lg-none(:interval="3000" indicators='' label-indicators="Selecciona un slide para mostrar")
                  b-carousel-slide(img-blank  img-alt="comentarios seguro de vida con devolucion")
                    img(v-lazy-load data-src="@/static/media/seguro_vida/home/icono_protege.svg" alt="icono protege seguro de vida")
                    b-row.d-flex.d-xl-none
                      b-col.text-center(cols="12" lg="4")
                        img.icono-testimonio(v-lazy-load data-src="@/static/media/seguro_vida/home/testimonio_margarita-seguro_de_vida.png" alt="testimonio de seguro de vida")
                  ...
                  b-carousel-slide(img-blank img-alt="comentarios seguro de vida con devolucion")
                    ...
                    b-row.d-flex.d-xl-none
                      b-col.text-center(cols="12" lg="4")
                        img.icono-testimonio(v-lazy-load data-src="@/static/media/seguro_vida/home/testimonio_alberto-seguro_de_vida.png" alt="testimonio de seguro de vida")
                      b-col.text-center.px-0.mt-4(cols="12")
                  ...
                  b-carousel-slide(img-blank  img-alt="comentarios seguro de vida con devolucion")
                    ...
                    b-row.d-flex.d-xl-none
                      b-col.text-center(cols="12" lg="4")
                        img.icono-testimonio(v-lazy-load data-src="@/static/media/seguro_vida/home/testimonio_demesio-seguro_de_vida.png" alt="testimonio de seguro de vida")
                      b-col.text-center.px-0.mt-4(cols="12")
                ...
                b-row.box.justify-content-center.px-0.d-none.d-lg-flex
                  b-col(lg="4" xl="3")
                    div.borde
                      ...
                      b-row.d-flex
                        b-col.text-center(cols="12")
                          img.icono-testimonio(style="width: 80px;" v-lazy-load data-src="@/static/media/seguro_vida/home/testimonio_margarita-seguro_de_vida.png" alt="testimonio de seguro de vida")
...
export default {
      ...
      preguntasFrecuentes: [
        ...
        },
        {
          ...
          respuestas: [
              ...
              '<h3> En caso la anulación se dé después de dicho tiempo, la devolución de la prima será únicamente sobre los días de seguro contratados pero no gozados.</h3>',
  ...
  components: {
    FormDni,
    AboutSeguroVida,
    Counter: () => import('@/components/common/Counter').then(module => module)
  },
  created () {
