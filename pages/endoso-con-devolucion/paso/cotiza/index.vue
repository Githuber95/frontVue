<template lang="pug">
  section#cotiza
    ...
    section
      b-modal#verifyData.abandono.endosos.bg-general(static size="md" centered hide-footer hide-header)
        b-container
      ...
      b-modal#quote.abandono.endosos.bg-general(static size="md" centered hide-footer hide-header)
        b-container
          b-row.justify-content-center
            b-col.text-center.mb-5(cols="12")
