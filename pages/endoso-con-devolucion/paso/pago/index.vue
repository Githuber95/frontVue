<template lang="pug"> 
  section#pago(ref="pago")
    ...
    b-modal#pay.abandono.bg-general.endosos(static size="md" centered hide-footer hide-header)
      b-container
        b-row.justify-content-center
        ...
        b-row.text-center
          ...
          b-col(cols="12").mt-4
            h3.text-primary Recuerda que si todo sale <br> bien, <span class="omnes-semibold"> te devolvemos S/ {{ parseDecimal(parseFloat($store.state.common.cotizacion.montoDevolucion)) }} </span><br> para que puedas utilizarlo en:
          b-col(cols="12").my-4
