                ...
                b-row.text-primary.justify-content-center
                  ...
                  b-col.mx-xl-5(cols="12").text-secondary
                    ...
                    b-col.bg-secondary-opacity(cols="12")
                      b-row.px-0
                        b-col(cols="8" xl="7")
                          p(v-if="$store.state.common.cotizacion.frecuenciaPago == 'M' || $store.state.common.cotizacion.frecuenciaPago == 'mensual'") Pagarás mensual
                          p(v-if="$store.state.common.cotizacion.frecuenciaPago == 'T' || $store.state.common.cotizacion.frecuenciaPago == 'trimestral'") Pagarás trimestral
                          p(v-if="$store.state.common.cotizacion.frecuenciaPago == 'S' || $store.state.common.cotizacion.frecuenciaPago == 'semestral'") Pagarás semestral
                          p(v-if="$store.state.common.cotizacion.frecuenciaPago == 'A' || $store.state.common.cotizacion.frecuenciaPago == 'anual'") Pagarás anual
...
export default {
  ...
  data () {
    return {
      currentChannel: 'Endoso con devolución',
      maxPrimaAnual: 5400, 
      stepClient: '1',
      formPlaft: {
        profesion: '0',
  ...
  mounted () {
    ...
    let goPath =  '/seguro-de-vida/endoso-con-devolucion'
    ...
    if (this.$store.state.payment.numeroPoliza) {
      ...
      let productName = 'Endoso con devolución'
      let productId = 'EndosoDevolucion'
      ...
      let goPath = '/endoso-con-devolucion'
  ...
  methods: {
    copyURL (e, type) {
      window.dataLayer.push({
        'event': 'Confidrmar compartir Copiar',
