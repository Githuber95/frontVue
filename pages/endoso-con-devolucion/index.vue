<template lang="pug">
  div
    section#home(ref="home")
      b-container
        div.box-cotiza
          b-row.cotiza.pt-5.endosos_multibanco(ref="cotiza")
            b-col.title.left.mt-lg-0.endosos_multibanco(cols="12" lg="6" xl="7" order="1" order-lg="2")
              b-row.principal.justify-content-center.justify-content-lg-left
                b-col.pl-2.pl-xl-0.px-0.px-lg-0(cols="11" lg="12")
                  ...
                  h1.omnes-medium.text-primary.lh-1.d-none.d-xl-block.w-75 Obtén tu seguro <br> Vida Cash con <br>devolución de <span class="omnes-semibold">hasta 150%</span> 
...
export default {
  ...
  created () {
    this.$store.commit('common/setSubchannel', 'ENDOSOS_MULTIBANCOS')
