<template lang="pug">
  section#home-box
    ...
    main
      // Component HEADE
      header-is(:showBanner="showBanner" :event="'pandemia'")
      nuxt(:class="[showBanner ? 'pt-box-banner pt-lg-0' : '']")
      // Component FOOTER
    div.writeme(v-if="$route.path == '/paso/pago'")
      a(target="_blank" :href="`https://api.whatsapp.com/send?phone=51933559693`" @click="writeChat" rel="noopener")
        img.call.d-lg-none(style="width:3rem;" src="@/static/media/icons/whatsapp_icon.svg" alt="Escribir algún contacto")
